  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between text-xs">
          ...
          <div className="flex items-center space-x-1 shrink-0">
            <button
              ...
              className="p-1.5 text-brand-600 hover:text-brand-700 font-bold"
            ...
            <button
              ...
              className="p-1.5 text-gray-400 hover:text-rose-500 font-bold"
              title="Clear all"
            >
        ...
        {/* Notifications List */}
        <div className="divide-y divide-gray-100 dark:divide-gray-800 max-h-[55vh] overflow-y-auto pr-1">
          {filtered.length === 0 ? (
            ...
            filtered.map(item => (
              ...
              >
                <div className="p-2 rounded-xl bg-white dark:bg-surface-darkCard shadow-xs shrink-0 mt-0.5">
                  {getIcon(item.type, item.severity)}
                </div>

                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <h4 className={`text-xs font-bold truncate ${!item.isRead ? 'text-brand-900 dark:text-white' : 'text-gray-700 dark:text-gray-300'}`}>
                      {item.title}
                    </h4>
