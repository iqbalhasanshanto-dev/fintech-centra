...
export const AppShell: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#FAFAFA] dark:bg-[#0A0E1A] text-gray-900 dark:text-gray-100 flex flex-col antialiased transition-colors duration-200">
      ...
      {/* Persistent Slim Top Header with Quick Add */}
      <Header
      ...
      {/* Main Screen Content Container with generous bottom clearance for nav dock */}
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 md:py-8 pb-36 sm:pb-40">
        {activeTab === 'home' && (
          <HomeScreen
      ...
      {/* Centra Footer */}
      <footer id="footer" className="max-w-7xl mx-auto w-full px-6 py-8 pb-28 md:pb-28 border-t border-gray-200 dark:border-[#232C45] flex flex-col md:flex-row items-center justify-between gap-4 transition-colors">
